...
describe('Home', () => {
  ...
  describe('signup form', () => {
    it('registers a user from the form', async () => {
      ...
      const email = 'rookie@accomplay.com';
    ...
    it('registers a user with group invite if groupInvite in the query', async () => {
      ...
      await fillOutUserForm('invitedUser', 'invited@accomplay.com', '1veGotFri3ndsHooray!');
    ...
    it('registers a user with group invite if p in the query', async () => {
      ...
      await fillOutUserForm('alsoInvitedUser', 'invited2@accomplay.com', '1veGotFri3nds2!');
    ...
    it('registers a user with group invite invite if both p and groupInvite are in the query', async () => {
      ...
      await fillOutUserForm('doublyInvitedUser', 'invited3@accomplay.com', '1veGotSm4rtFri3nds!');
