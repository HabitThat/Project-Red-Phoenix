...
api.subscribe = async function subscribe (
  ...
  switch (sku) { // eslint-disable-line default-case
    case 'com.phoenixlounge.android.accomplay.subscription.1month':
      subCode = 'basic_earned';
      break;
    case 'com.phoenixlounge.android.accomplay.subscription.3month':
      subCode = 'basic_3mo';
      break;
    case 'com.phoenixlounge.android.accomplay.subscription.6month':
      subCode = 'basic_6mo';
      break;
    case 'com.phoenixlounge.android.accomplay.subscription.12month':
      subCode = 'basic_12mo';
      break;
  }
...
api.noRenewSubscribe = async function noRenewSubscribe (options) {
  ...
  let subCode;
  switch (sku) { // eslint-disable-line default-case
    case 'com.phoenixlounge.android.accomplay.norenew_subscription.1month':
      subCode = 'basic_earned';
      break;
    case 'com.phoenixlounge.android.accomplay.norenew_subscription.3month':
      subCode = 'basic_3mo';
      break;
    case 'com.phoenixlounge.android.accomplay.norenew_subscription.6month':
      subCode = 'basic_6mo';
      break;
    case 'com.phoenixlounge.android.accomplay.norenew_subscription.12month':
      subCode = 'basic_12mo';
      break;
  }
  const sub = subCode ? shared.content.subscriptionBlocks[subCode] : false;
