...
describe('Apple Payments', () => {
  ...
  describe('verifyPurchase', () => {
    ...
    beforeEach(() => {
      token = 'testToken';
      sku = 'com.phoenixlounge.ios.accomplay.iap.21gems';
      user = new User();
      ...
      iapGetPurchaseDataStub = sinon.stub(iap, 'getPurchaseData')
        .returns([{
          productId: 'com.phoenixlounge.ios.Accomplay.21gems',
          transactionId: token,
        }]);
    ...
    const gemsCanPurchase = [
      {
        productId: 'com.phoenixlounge.ios.Accomplay.4gems',
        gemsBlock: '4gems',
      },
      {
        productId: 'com.phoenixlounge.ios.Accomplay.20gems',
        gemsBlock: '21gems',
      },
      {
        productId: 'com.phoenixlounge.ios.Accomplay.21gems',
      ...
      {
        productId: 'com.phoenixlounge.ios.Accomplay.42gems',
        gemsBlock: '42gems',
      },
      {
        productId: 'com.phoenixlounge.ios.Accomplay.84gems',
        gemsBlock: '84gems',
      },
    ];
    ...
    it('gifts gems', async () => {
      ...
      expect(paymentBuySkuStub).to.be.calledWith({
        ...
        paymentMethod: applePayments.constants.PAYMENT_METHOD_APPLE,
        sku: 'com.phoenixlounge.ios.Accomplay.4gems',
        headers,
      });
    });
  });
  ...
  describe('subscribe', () => {
    ...
    beforeEach(() => {
      ...
      sku = 'com.phoenixlounge.ios.accomplay.subscription.3month';
    ...
    const subOptions = [
      ...
      {
        sku: 'com.phoenixlounge.ios.accomplay.subscription.6month',
        subKey: 'basic_6mo',
      },
      {
        sku: 'com.phoenixlounge.ios.accomplay.subscription.12month',
        subKey: 'basic_12mo',
      },
    ];
