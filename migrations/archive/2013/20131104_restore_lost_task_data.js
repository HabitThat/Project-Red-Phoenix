...
let backupUsers = mongo.db('localhost:27017/phoenixlounge_old?auto_reconnect').collection('users');
let liveUsers = mongo.db('localhost:27017/phoenixlounge_new?auto_reconnect').collection('users');
